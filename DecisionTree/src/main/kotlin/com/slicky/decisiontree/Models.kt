 ...
 */
data class Decision(val id: String, val flags: List<String>, val text: String, val more: String?, val answers: List<Answer>)
data class Answer(val text: String, val flags: List<String>, val more: String?, val actionID: String)
